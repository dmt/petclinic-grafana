...
this repo has indeed become incredibly outdated now. In particular there is now the grafana/otel-lgtm docker image (and spring support for it) that 
makes most of this repo moot.
